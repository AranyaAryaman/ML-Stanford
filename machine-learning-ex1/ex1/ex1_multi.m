...
theta1=theta2=theta = zeros(3, 1);
[theta, J_history] = gradientDescentMulti(X, y, theta, alpha1, num_iters);
%[theta1, J_history1] = gradientDescentMulti(X, y, theta1, alpha2, num_iters);
%[theta2, J_history2] = gradientDescentMulti(X, y, theta2, alpha3, num_iters);
